...
int capture_frame(Frame* newFrame) {
  ...
  newFrame->thumb = map(analogRead(34), 0, 4095, 0, 100);
  newFrame->index = map(analogRead(35), 0, 4095, 0, 100);
  newFrame->middle = map(analogRead(32), 0, 4095, 0, 100);
  newFrame->ring = map(analogRead(33), 0, 4095, 0, 100);
  newFrame->pinky = map(analogRead(25), 0, 4095, 0, 100);
  return 0;
}
